(function () {
  ...
  function setOptions(list) {
    ...
    to.innerHTML = "";
    for (const u of list) {
      const o1 = document.createElement("option"); o1.value = u.key; o1.textContent = u.name; from.appendChild(o1);
      const o2 = document.createElement("option"); o2.value = u.key; o2.textContent = u.name; to.appendChild(o2);
    }
    // sensible defaults
